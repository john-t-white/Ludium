...
On every re-review, render an explicit verdict on each thread you own:
    ...
    **review-test-plan** — RESOLVE — <one line: what satisfied you>
    **review-test-plan** — DON'T RESOLVE — <one line: what is still missing>
...
attributed to you, in one review carrying all of this round's findings:
    ...
    {"event":"COMMENT","body":"**review-test-plan** — round <n>. <summary>","comments":[
